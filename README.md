...
- [上手指南(Guide)](#上手指南guide)
  ...
  - [功能演示(Function Performances)](#功能演示function-performances)
- [免责声明(Disclaimers)](#免责声明disclaimers)

## 上手指南(Guide)

### 项目概述(Project Introduction)
本项目基于 **C++** 和 **HTML/CSS/JavaScript** 实现了一个类Rust语言编译器及其可视化界面，为2025年同济大学编译原理课程设计项目。  
项目主要分为两大部分：
...
> The project designs and implements a Rust-like compiler and its visualization application based on **C++** language and **HTML/CSS/JavaScript** framework, and is one of the Compilation Principle Courseworks of 2025 Tongji University.  
...
您可以在`document.pdf`中查看项目设计的详细说明文档，`demo.mp4`是本项目运行的演示视频。
> For detailed designs of the project, you may read `document.pdf`, and the `demo.mp4` offers a real-time demo vedio when the web application performances.
...
<img width="75%" height="auto" alt="image" src="https://github.com/user-attachments/assets/ae8f04cd-b9b9-454a-a348-3287a22717e5" />

<img width="75%" height="auto" alt="image" src="https://github.com/user-attachments/assets/2d14d157-4680-4134-b996-9386df034f7e" />
